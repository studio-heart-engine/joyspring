...
#export (PackedScene) var opening = preload('res://platformer/levels/Level_18.tscn')
#export (PackedScene) var opening = preload('res://platformer/PlatformerLayeredTemplateTEST.tscn')
