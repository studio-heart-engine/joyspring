...
var dynamic_tileset = load("res://graphics/tilesets/background_tileset.tres")
...
func update_tileset():
	var tileset_image_path = "res://graphics/tilesets/" + get_time_of_day() + "/" + get_tile_material() + "Back.png"
