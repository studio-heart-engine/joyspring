...
func _ready():
	...
	if self.get_parent().get_name() == 'Layer0' or \
	   (self.get_parent().get_name() == 'PathFollow2D' and \
	   self.get_parent().get_parent().get_parent().get_parent().get_parent().get_name() == 'Layer0'):
...
#		self.collision_mask = pow(2, 0) + pow(2, 1) + pow(2, 4)
	...
	if self.get_parent().get_name() == 'Layer1' or \
	   (self.get_parent().get_name() == 'PathFollow2D' and \
	   self.get_parent().get_parent().get_parent().get_parent().get_parent().get_name() == 'Layer1'):
